...
public class ServiceListActivity extends ActionBarActivity
    ...
    private DeviceDisplay currentDevice;
    ...
    public void onItemSelected(int device_id, int service_id) {
        if (mTwoPane) {
            ...
            arguments.putInt(ServiceDetailFragment.SERVICE_ID, service_id);
            ...
            detailIntent.putExtra(ServiceDetailFragment.SERVICE_ID, service_id);
